...
public class EvaluationServicesResponseBuilder {
	 ...
	 * 
	 */
	public static final ResponseEntity<ResponseVO<FindDetailEvaluationResponseVO>> buildFindDetailResponse(
			ResponseVO<FindDetailEvaluationResponseVO> serviceResponse) {
	 ...
	 * 
	 */
	public static final ResponseEntity<ResponseVO<List<FindListEvaluationResponseVO>>> buildFindListEvaluationResponse
	(ResponseVO<List<FindListEvaluationResponseVO>> serviceResponse) {
