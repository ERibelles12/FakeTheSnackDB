...
public class FuncionesBusinessError {
	
	private FuncionesBusinessError() {
	...
	public static final String REQUIRED_INGREDIENT_MEAN_PERCENTAGE_ERROR 			= "REQUIRED_INGREDIENT_MEAN_PERCENTAGE_ERROR";
	public static final String REQUIRED_INGREDIENT_STD_PERCENTAGE_ERROR 			= "REQUIRED_INGREDIENT_STD_PERCENTAGE_ERROR";
