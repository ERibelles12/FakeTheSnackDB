...
public class FindDetailUsuarioResponseVO implements Serializable {
	...
	/**
	 * @return the lastLoginActive
	 */
	public Date getLastLoginActive() {
		return lastLoginActive;
	}
	/**
	 * @param lastLoginActive the lastLoginActive to set
	 */
	...
	/**
	 * @return the passwordStatusChangedAt
	 */
	public Date getPasswordStatusChangedAt() {
		return passwordStatusChangedAt;
	}
	/**
	 * @param passwordStatusChangedAt the passwordStatusChangedAt to set
	 */
