...
import de.pecus.api.controllers.AplicacionController;
...
public class AplicacionControllerImpl implements AplicacionController {
	...
	public static final SmartLogger LOGGER = SmartLoggerFactory.getLogger(AplicacionController.class);
	...
	public ResponseEntity<ResponseVO<Long>> createAplicacion(@RequestHeader Map<String, String> headers,
			@RequestBody CreateAplicacionRequestVO body) {
		
			// Generamos el objeto requestVO
			RequestVO<CreateAplicacionRequestVO> requestVO = RequestVOUtil.setNewRequestVO(headers,body);

			ResponseEntity<ResponseVO<Long>> response = null;
			try {
				// Invocar al servicio
				ResponseVO<Long> serviceResponse = aplicacionService.create(requestVO);
	...
	@ApiImplicitParams({
		...
		@ApiImplicitParam(name = "id-client-invoke", value = "21", paramType = "header", dataTypeClass = String.class, required = true),
		@ApiImplicitParam(name = "client-operation-code", value = "qWERGFDSRSGfsdertRTRe2345RTd", paramType = "header", dataTypeClass = String.class, required = true) })
	@PutMapping(value = "/aplicacion/{id}", produces = MediaType.APPLICATION_JSON_VALUE)
	public ResponseEntity<ResponseVO<Long>> updateAplicacion(@RequestHeader Map<String, String> headers, 
			@PathVariable(name = "id", required = false) Long id, 
			@RequestBody UpdateAplicacionRequestVO body) {
			...
			// Generamos el objeto requestVO
			RequestVO<UpdateAplicacionRequestVO> requestVO = RequestVOUtil.setNewRequestVO(headers,body);
			
			try {
				// Invocar al servicio
				ResponseVO<Long> serviceResponse = aplicacionService.update(requestVO);
	...
	@ApiImplicitParams({
		...
		@ApiImplicitParam(name = "id-client-invoke", value = "21", paramType = "header", dataTypeClass = String.class, required = true),
		@ApiImplicitParam(name = "client-operation-code", value = "qWERGFDSRSGfsdertRTRe2345RTd", paramType = "header", dataTypeClass = String.class, required = true) })
	@DeleteMapping(value = "/aplicacion/{id}", produces = MediaType.APPLICATION_JSON_VALUE)
	public ResponseEntity<ResponseVO<Boolean>> deleteAplicacion(@RequestHeader Map<String, String> headers,
			@PathVariable("id") Long id) {
		// Declaracion de variables
		ResponseEntity<ResponseVO<Boolean>> response = null;
		
		// Generamos el objeto requestVO
		DeleteAplicacionRequestVO deleteAplicacionRequestVO = new DeleteAplicacionRequestVO();
		deleteAplicacionRequestVO.setId(id);
		RequestVO<DeleteAplicacionRequestVO> requestVO = RequestVOUtil.setNewRequestVO(headers,deleteAplicacionRequestVO);
		

		try {
			
			ResponseVO<Boolean> serviceResponse = aplicacionService.delete(requestVO);
	...
	@ApiImplicitParams({
		...
		@ApiImplicitParam(name = "id-client-invoke", value = "21", paramType = "header", dataTypeClass = String.class, required = true),
		@ApiImplicitParam(name = "client-operation-code", value = "qWERGFDSRSGfsdertRTRe2345RTd", paramType = "header", dataTypeClass = String.class, required = true) })
	@GetMapping(value = "/aplicacion/detail", produces = MediaType.APPLICATION_JSON_VALUE)
	public ResponseEntity<ResponseVO<FindDetailAplicacionResponseVO>> findDetailAplicacion(
			@RequestHeader Map<String, String> headers, 
			@RequestParam(value = "id", required= false) Long id,
			@RequestParam(value = "idNombre", required = false) String idNombre) {

		// Declaracion de variables
		ResponseEntity<ResponseVO<FindDetailAplicacionResponseVO>> response = null;

		// Crear el objeto requestVO
		FindDetailAplicacionRequestVO findDetailAplicacionRequestVO = new FindDetailAplicacionRequestVO();
		findDetailAplicacionRequestVO.setId(id);
		findDetailAplicacionRequestVO.setIdNombre(idNombre);
		RequestVO<FindDetailAplicacionRequestVO> requestVO = RequestVOUtil.setNewRequestVO(headers,findDetailAplicacionRequestVO);

		try {
			
			// Invocar al metodo de busqueda
			ResponseVO<FindDetailAplicacionResponseVO> serviceResponse = aplicacionService.findDetail(requestVO);
			
			response = AplicacionServicesResponseBuilder.buildFindDetailResponse(serviceResponse);

		} catch (Exception exception) {
			// Excepcion no controlada
			ResponseVO<FindDetailAplicacionResponseVO> exceptionResponse = ResponseUtil.getErrorResponse(exception);
			response = ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR).body(exceptionResponse);
		}
		return response;
	}
	...
	@ApiImplicitParams({
		...
		@ApiImplicitParam(name = "id-client-invoke", value = "21", paramType = "header", dataTypeClass = String.class, required = true),
		@ApiImplicitParam(name = "client-operation-code", value = "qWERGFDSRSGfsdertRTRe2345RTd", paramType = "header", dataTypeClass = String.class, required = true) })
	@GetMapping(value = "/aplicacion/list", produces = MediaType.APPLICATION_JSON_VALUE)
	public ResponseEntity<ResponseVO<List<FindListAplicacionResponseVO>>> findListAplicacion(
			@RequestHeader Map<String, String> headers, 
			...
			@RequestParam(value = "idNombre", required = false) String idNombre){
		// Declarar variables
		ResponseEntity<ResponseVO<List<FindListAplicacionResponseVO>>> response = null;

		FindListAplicacionRequestVO findListAplicacionRequestVO = new FindListAplicacionRequestVO();
		findListAplicacionRequestVO.setIdNombre(idNombre);
		RequestVO<FindListAplicacionRequestVO> requestVO = RequestVOUtil.setNewRequestVO(headers, page, size, orderBy,
				orderType, findListAplicacionRequestVO);

		try {

			ResponseVO<List<FindListAplicacionResponseVO>> serviceResponse = aplicacionService.findList(requestVO);
			response = AplicacionServicesResponseBuilder.buildFindListAplicacionResponse(serviceResponse);

		} catch (Exception exception) {
			// Excepcion no controlada
			ResponseVO<List<FindListAplicacionResponseVO>> exceptionResponse = ResponseUtil
