...
import de.pecus.api.controllers.FuncionController;
...
@RestController
@RequestMapping("")
public class FuncionControllerImpl implements FuncionController{
	...
	@PostMapping(value = "/funcion", produces = MediaType.APPLICATION_JSON_VALUE)
	public ResponseEntity<ResponseVO<Long>> createFuncion(@RequestHeader Map<String, String> headers,
			@RequestBody CreateFuncionRequestVO body) {
		
			// Generamos el objeto requestVO
			RequestVO<CreateFuncionRequestVO> requestVO = RequestVOUtil.setNewRequestVO(headers,body);

			ResponseEntity<ResponseVO<Long>> response = null;
			try {
				// Invocar al servicio
				ResponseVO<Long> serviceResponse = funcionService.createFuncion(requestVO);
	...
	@ApiImplicitParams({
		...
		@ApiImplicitParam(name = "id-client-invoke", value = "21", paramType = "header", dataTypeClass = String.class, required = true),
		@ApiImplicitParam(name = "client-operation-code", value = "qWERGFDSRSGfsdertRTRe2345RTd", paramType = "header", dataTypeClass = String.class, required = true) })
	@PutMapping(value = "/funcion/{id}", produces = MediaType.APPLICATION_JSON_VALUE)
	public ResponseEntity<ResponseVO<Long>> updateFuncion(@RequestHeader Map<String, String> headers, 
			@PathVariable(name = "id", required = false) Long id, 
			@RequestBody UpdateFuncionRequestVO body) {
			...
			// Generamos el objeto requestVO
			RequestVO<UpdateFuncionRequestVO> requestVO = RequestVOUtil.setNewRequestVO(headers,body);
			
			try {
				// Invocar al servicio
				ResponseVO<Long> serviceResponse = funcionService.updateFuncion(requestVO);
	...
	@ApiImplicitParams({
		...
		@ApiImplicitParam(name = "id-client-invoke", value = "21", paramType = "header", dataTypeClass = String.class, required = true),
		@ApiImplicitParam(name = "client-operation-code", value = "qWERGFDSRSGfsdertRTRe2345RTd", paramType = "header", dataTypeClass = String.class, required = true) })
	@DeleteMapping(value = "/funcion/{id}", produces = MediaType.APPLICATION_JSON_VALUE)
	public ResponseEntity<ResponseVO<Boolean>> deleteFuncion(@RequestHeader Map<String, String> headers,
			@PathVariable("id") Long id) {
		// Declaracion de variables
		ResponseEntity<ResponseVO<Boolean>> response = null;
		
		// Generamos el objeto requestVO
		DeleteFuncionRequestVO deleteFuncionRequestVO = new DeleteFuncionRequestVO();
		deleteFuncionRequestVO.setId(id);
		RequestVO<DeleteFuncionRequestVO> requestVO = RequestVOUtil.setNewRequestVO(headers,deleteFuncionRequestVO);
		

		try {
			
			ResponseVO<Boolean> serviceResponse = funcionService.deleteFuncion(requestVO);
	...
	@ApiImplicitParams({
		...
		@ApiImplicitParam(name = "id-client-invoke", value = "21", paramType = "header", dataTypeClass = String.class, required = true),
		@ApiImplicitParam(name = "client-operation-code", value = "qWERGFDSRSGfsdertRTRe2345RTd", paramType = "header", dataTypeClass = String.class, required = true) })
	@GetMapping(value = "/funcion/detail", produces = MediaType.APPLICATION_JSON_VALUE)
	public ResponseEntity<ResponseVO<FindDetailFuncionResponseVO>> findDetailFuncion(
		...
		FindDetailFuncionRequestVO findDetailFuncionRequestVO = new FindDetailFuncionRequestVO();
		findDetailFuncionRequestVO.setId(id);
		RequestVO<FindDetailFuncionRequestVO> requestVO = RequestVOUtil.setNewRequestVO(headers,findDetailFuncionRequestVO);

		try {
			
			// Invocar al metodo de busqueda
			ResponseVO<FindDetailFuncionResponseVO> serviceResponse = funcionService.findDetailFuncion(requestVO);
			
			response = AplicacionServicesResponseBuilder.buildFindDetailFuncionResponse(serviceResponse);

		} catch (Exception exception) {
			// Excepcion no controlada
			ResponseVO<FindDetailFuncionResponseVO> exceptionResponse = ResponseUtil.getErrorResponse(exception);
			response = ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR).body(exceptionResponse);
		}
		return response;
	}
	...
	@ApiImplicitParams({
		...
		@ApiImplicitParam(name = "id-client-invoke", value = "21", paramType = "header", dataTypeClass = String.class, required = true),
		@ApiImplicitParam(name = "client-operation-code", value = "qWERGFDSRSGfsdertRTRe2345RTd", paramType = "header", dataTypeClass = String.class, required = true) })
	@GetMapping(value = "/funcion/list/assing/", produces = MediaType.APPLICATION_JSON_VALUE)
	public ResponseEntity<ResponseVO<List<FindListFuncionResponseVO>>> findListFuncionAssing(
			@RequestHeader Map<String, String> headers, 
		...
		FindListFuncionRequestVO findListFuncionRequestVO = new FindListFuncionRequestVO();
		findListFuncionRequestVO.setIdNombre(idNombre);
		findListFuncionRequestVO.setIdAplicacion(idAplicacion);
		findListFuncionRequestVO.setIdRol(idRol);
		
		RequestVO<FindListFuncionRequestVO> requestVO = RequestVOUtil.setNewRequestVO(headers, findListFuncionRequestVO);

		try {

			ResponseVO<List<FindListFuncionResponseVO>> serviceResponse = funcionService.findListFuncionAssing(requestVO);
			response = AplicacionServicesResponseBuilder.buildFindListFuncionResponse(serviceResponse);

		} catch (Exception exception) {
			// Excepcion no controlada
			ResponseVO<List<FindListFuncionResponseVO>> exceptionResponse = ResponseUtil
	...
	@ApiImplicitParams({
		...
		@ApiImplicitParam(name = "id-client-invoke", value = "21", paramType = "header", dataTypeClass = String.class, required = true),
		@ApiImplicitParam(name = "client-operation-code", value = "qWERGFDSRSGfsdertRTRe2345RTd", paramType = "header", dataTypeClass = String.class, required = true) })
	@GetMapping(value = "/funcion/list", produces = MediaType.APPLICATION_JSON_VALUE)
	public ResponseEntity<ResponseVO<List<FindListFuncionResponseVO>>> findListFuncion(
			@RequestHeader Map<String, String> headers, 
			...
			@RequestParam(value = "idAplicacion", required = false) Long idAplicacion,
			@RequestParam(value = "idNombre", required = false) String idNombre,
 			@RequestParam(value = "noAsignados", required = false) Boolean noAsignados,
 			@RequestParam(value = "idRol", required = false) Long idRol){
		// Declarar variables
		ResponseEntity<ResponseVO<List<FindListFuncionResponseVO>>> response = null;
		...
		RequestVO<FindListFuncionRequestVO> requestVO = RequestVOUtil.setNewRequestVO(headers, page, size, orderBy,
				orderType, findListFuncionRequestVO);

		try {

			ResponseVO<List<FindListFuncionResponseVO>> serviceResponse = funcionService.findListFuncion(requestVO);
			response = AplicacionServicesResponseBuilder.buildFindListFuncionResponse(serviceResponse);
