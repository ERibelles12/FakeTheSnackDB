...
public class NumberToLetterUtil {
     ...
     * @throws NumberFormatException Si valor del número no es válido (fuera de
     *                               rango o )
	...
	public static String convertNumberToLetter(BigDecimal number) throws NumberFormatException {
		...
		int millon = Integer.parseInt(String.valueOf(getDigitAt(splitNumber[0], 8)) + String.valueOf(getDigitAt(splitNumber[0], 7))
		...
		int miles = Integer.parseInt(String.valueOf(getDigitAt(splitNumber[0], 5)) + String.valueOf(getDigitAt(splitNumber[0], 4))
		...
		/*
		 * if (centavos == 1) { converted.append(" CON UN CENTAVO"); } else if
		 * (centavos > 1) { converted.append(" CON " +
